...
ar: {
    ...
    purchaseProcedure: [
      { text: "1. تحقق من العقارات والاختيارات في الجدول." },
      { text: "2. اتصل بقسم المبيعات لدينا على الرقم المذكور." },
      { text: "3. سيقوم المستشار بمساعدتك لإتمام المعاملة." },
      { text: "4. ستتلقى رسالة تأكيد عبر البريد الإلكتروني مع التفاصيل." },
      { text: "شكراً لثقتك." }
    ],
